...
def SwinB(pretrained=True, path_pretrained_models=''):
    model = SwinTransformer(embed_dim=128, depths=[2, 2, 18, 2], num_heads=[4, 8, 16, 32], window_size=12)
    if pretrained is True:
        model.load_state_dict(torch.load(f'{path_pretrained_models}/swin_base_patch4_window12_384_22kto1k.pth', map_location='cpu')['model'], strict=False)
